...
public class CategoryControllerTest {
    ...
    @Test
    void updateCategory_デフォルトカテゴリを更新しようとした場合_403Forbiddenを返す() throws Exception {
        // Arrange
        CategoryUpdateRequest request = new CategoryUpdateRequest();
        request.setName("更新カテゴリ");
    ...
    @Test
    void updateCategory_DB更新時に予期せぬエラーが発生した場合_500InternalServerErrorを返す() throws Exception {
        // Arrange
        CategoryUpdateRequest request = new CategoryUpdateRequest();
        request.setName("テストカテゴリ");
